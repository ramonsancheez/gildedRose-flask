...
api.add_resource(nombre, "/inventario/name/<itemNombre>")
api.add_resource(quality, "/inventario/quality/<numQuality>")
api.add_resource(sell_in, "/inventario/sell_in/<numSellIn>")
